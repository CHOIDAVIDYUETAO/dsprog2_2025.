...
class CalculatorApp(ft.Container):
    ...
    def button_clicked(self, e):
        ...
        if data == "AC":
            ...
            self.result.value = str(self.format_number(math.sin(val)))
            self.new_operand = True
            
        elif data == "cos":
            val = float(self.result.value)
            self.result.value = str(self.format_number(math.cos(val)))
            self.new_operand = True
            
        elif data == "tan":
            val = float(self.result.value)
            self.result.value = str(self.format_number(math.tan(val)))
            self.new_operand = True
            ...
            if val <= 0:
                ...
                self.result.value = str(self.format_number(math.log(val)))
            self.new_operand = True
